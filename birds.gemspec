...
Gem::Specification.new do |s|
  ...
  s.files = ["COPYING".freeze, "ChangeLog".freeze, "README".freeze, "Rakefile".freeze, "config.ru.sample".freeze, "lib/birds.rb".freeze, "lib/birds/app.rb".freeze, "lib/birds/app/controllers.rb".freeze, "lib/birds/app/helpers.rb".freeze, "lib/birds/app/helpers/controller.rb".freeze, "lib/birds/app/helpers/view.rb".freeze, "lib/birds/app/public/css/birds.css".freeze, "lib/birds/app/public/favicon.ico".freeze, "lib/birds/app/public/images/bird1.png".freeze, "lib/birds/app/public/images/bird2.png".freeze, "lib/birds/app/public/images/bird3.png".freeze, "lib/birds/app/public/images/birds.png".freeze, "lib/birds/app/public/js/birds.js".freeze, "lib/birds/app/settings.rb".freeze, "lib/birds/app/views/_display.erb".freeze, "lib/birds/app/views/_documents.erb".freeze, "lib/birds/app/views/_facets.erb".freeze, "lib/birds/app/views/_spellcheck.erb".freeze, "lib/birds/app/views/browse.erb".freeze, "lib/birds/app/views/document.erb".freeze, "lib/birds/app/views/index.erb".freeze, "lib/birds/app/views/layout.erb".freeze, "lib/birds/app/views/scroll.erb".freeze, "lib/birds/rack_app.rb".freeze, "lib/birds/version.rb".freeze]
  s.homepage = "http://github.com/blackwinter/birds".freeze
  s.licenses = ["AGPL-3.0".freeze]
  s.post_install_message = "\nbirds-0.0.2 [2016-10-12]:\n\n* Include asset files in gemspec.\n\n".freeze
  s.rdoc_options = ["--title".freeze, "birds Application documentation (v0.0.2)".freeze, "--charset".freeze, "UTF-8".freeze, "--line-numbers".freeze, "--all".freeze, "--main".freeze, "README".freeze]
